export const TRAITS = {
  ...
  'Пехотинец': {
    origin: 'Житель НКР',
    description: 'Если экипировано: Пистолет-пулемёт Томпсона, Боевой карабин, Штурмовая винтовка, Осколочная граната или Боевой нож — их базовый урон на экране оружия и брони +1. Бонус складывается с модификациями.'
  },
  'Дом на пастбище': {
    origin: 'Житель НКР',
